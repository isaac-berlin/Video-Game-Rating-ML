...
rf_accuracy, bagging_accuracy, boosting_accuracy
print("")
...
results = {
    ...
    "Accuracy": [rf_accuracy_test_set, bagging_accuracy_test_set, boosting_accuracy_test_set],
    "Recall": [rf_recall_test_set, bagging_recall_test_set, boosting_recall_test_set],
    "Precision": [rf_precision_test_set, bagging_precision_test_set, boosting_precision_test_set],
    "F1 Score": [rf_f1_test_set, bagging_f1_test_set, boosting_f1_test_set]
}
